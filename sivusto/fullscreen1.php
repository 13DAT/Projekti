...
<head>
  ...
  <body>
  <input id="clickMe" type="button" value="painike"/>

<button><a href="http://i.imgur.com/LVYDgNw.jpg" class="fancybox" rel="gallery-1" id="painike" alt="open gallery" /></a></button>
